...
# names of counties & the key:value = county:votes
county_options = []
county_votes = {}
...
#largest county turnout and largest county's number of votes
lrg_turnout_county = ""
lrg_turn_count = 0
...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        #takes the county name from the rows
        county_name = row[1]
        ...
        #decision statement: logical operator (not in)
        ...
        #adds to the vote count as it loops over rows
